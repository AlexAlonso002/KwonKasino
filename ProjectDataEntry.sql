...
(1, '2024-01-10', 5, 50, 120.50),
(1, '2024-02-15', 12, 100, 250.00),
(1, '2024-03-10', 8, 75, 0),
(1, '2024-04-01', 20, 60, 150.00),
(1, '2024-05-22', 3, 80, 200.00),

-- Game 2: Poker VIP (GameID = 2)
(2, '2024-01-20', 14, 150, 300.00),
(2, '2024-02-25', 25, 200, 500.00),
(2, '2024-03-12', 2, 120, 0),
(2, '2024-04-18', 18, 180, 360.00),
(2, '2024-05-15', 7, 220, 450.00),

-- Game 3: Blackjack Classic (GameID = 3)
(3, '2024-01-15', 30, 40, 90.00),
(3, '2024-02-18', 10, 60, 140.00),
(3, '2024-03-25', 6, 100, 0),
(3, '2024-04-10', 21, 50, 120.00),
(3, '2024-05-30', 16, 70, 150.00),

-- Game 4: Blackjack VIP (GameID = 4)
(4, '2024-01-22', 28, 100, 250.00),
(4, '2024-02-05', 17, 150, 400.00),
(4, '2024-03-14', 4, 120, 0),
(4, '2024-04-08', 15, 130, 310.00),
(4, '2024-05-12', 11, 180, 450.00),

-- Game 5: Roulette Pro (GameID = 5)
(5, '2024-01-11', 23, 25, 60.00),
(5, '2024-02-28', 1, 50, 120.00),
(5, '2024-03-16', 19, 35, 0),
(5, '2024-04-20', 27, 40, 100.00),
(5, '2024-05-18', 9, 60, 150.00),

-- Game 6: Roulette Deluxe (GameID = 6)
(6, '2024-01-28', 24, 20, 50.00),
(6, '2024-02-14', 26, 40, 90.00),
(6, '2024-03-02', 13, 30, 0),
(6, '2024-04-05', 22, 50, 120.00),
(6, '2024-05-21', 8, 70, 160.00),

-- Game 7: High Stakes Poker (GameID = 7)
(7, '2024-01-17', 3, 300, 700.00),
(7, '2024-02-22', 6, 350, 900.00),
(7, '2024-03-08', 29, 250, 0),
(7, '2024-04-12', 20, 400, 1000.00),
(7, '2024-05-02', 12, 500, 1200.00),

-- Game 8: Blackjack Royale (GameID = 8)
(8, '2024-01-30', 7, 80, 200.00),
(8, '2024-02-18', 25, 120, 300.00),
(8, '2024-03-04', 18, 70, 0),
(8, '2024-04-25', 15, 90, 210.00),
(8, '2024-05-10', 1, 150, 400.00),

-- Game 9: High Roller Poker (GameID = 9)
(9, '2024-01-25', 11, 500, 1200.00),
(9, '2024-02-12', 22, 700, 1500.00),
(9, '2024-03-30', 13, 400, 0),
(9, '2024-04-15', 9, 600, 1400.00),
(9, '2024-05-08', 16, 800, 2000.00),

-- Game 10: Blackjack High Stakes (GameID = 10)
(10, '2024-01-21', 14, 150, 350.00),
(10, '2024-02-09', 5, 200, 500.00),
(10, '2024-03-13', 28, 100, 0),
(10, '2024-04-06', 30, 130, 330.00),
(10, '2024-05-19', 10, 180, 450.00),

-- Game 11: Roulette Royale (GameID = 11)
(11, '2024-01-10', 19, 40, 100.00),
(11, '2024-02-22', 27, 50, 120.00),
(11, '2024-03-07', 21, 35, 0),
(11, '2024-04-14', 23, 60, 150.00),
(11, '2024-05-29', 4, 80, 200.00),

-- Game 12: High Stakes Roulette (GameID = 12)
(12, '2024-01-25', 26, 300, 700.00),
(12, '2024-02-08', 29, 350, 900.00),
(12, '2024-03-16', 24, 250, 0),
(12, '2024-04-18', 6, 400, 1000.00),
(12, '2024-05-23', 17, 500, 1200.00),

-- Game 13: Texas Hold'em Poker (GameID = 13)
(13, '2024-01-14', 20, 150, 400.00),
(13, '2024-02-10', 12, 200, 500.00),
(13, '2024-03-22', 2, 100, 0),
(13, '2024-04-27', 9, 130, 330.00),
(13, '2024-05-16', 25, 180, 450.00),

-- Game 14: Baccarat Classic (GameID = 14)
(14, '2024-01-30', 30, 40, 90.00),
(14, '2024-02-24', 14, 60, 140.00),
(14, '2024-03-05', 7, 100, 0),
(14, '2024-04-20', 22, 50, 120.00),
(14, '2024-05-04', 8, 70, 160.00),

-- Game 15: Baccarat High Stakes (GameID = 15)
(15, '2024-01-22', 28, 300, 700.00),
(15, '2024-02-06', 13, 350, 900.00),
(15, '2024-03-09', 1, 250, 0),
(15, '2024-04-15', 16, 400, 1000.00),
(15, '2024-05-14', 18, 500, 1200.00),

-- Game 16: Baccarat Royale (GameID = 16)
(16, '2024-01-13', 5, 150, 400.00),
(16, '2024-02-18', 10, 200, 500.00),
(16, '2024-03-25', 28, 120, 0),
(16, '2024-04-30', 3, 180, 450.00),
(16, '2024-05-18', 27, 250, 600.00),
...
(21, '2024-02-26', 24, 50, 120.00),
(21, '2024-03-07', 29, 35, 0),
(21, '2024-04-20', 7, 60, 150.00),
(21, '2024-05-13', 22, 80, 200.00),

-- Game 22: Vegas Slots Mania (GameID = 22)
(22, '2024-01-28', 20, 4, 10.00),
(22, '2024-02-06', 19, 7, 20.00),
(22, '2024-03-16', 30, 5, 0),
(22, '2024-04-05', 12, 6, 15.00),
(22, '2024-05-19', 8, 10, 25.00),

-- Game 23: Wild West Poker (GameID = 23)
(23, '2024-01-18', 9, 50, 100.00),
(23, '2024-02-09', 16, 40, 90.00),
(23, '2024-03-10', 4, 35, 0),
(23, '2024-04-22', 5, 60, 150.00),
(23, '2024-05-25', 13, 70, 180.00),

-- Game 24: Dragon's Lair Slots (GameID = 24)
(24, '2024-01-12', 11, 2, 7.00),
(24, '2024-02-08', 27, 5, 20.00),
(24, '2024-03-03', 15, 3, 0),
(24, '2024-04-15', 14, 4, 12.00),
(24, '2024-05-28', 1, 6, 18.00),

-- Game 25: Neon Nights Slots (GameID = 25)
(25, '2024-01-20', 6, 10, 30.00),
(25, '2024-02-01', 25, 12, 40.00),
(25, '2024-03-21', 19, 8, 0),
(25, '2024-04-07', 29, 15, 35.00),
(25, '2024-05-26', 17, 20, 50.00),

-- Game 26: Treasure Quest Slots (GameID = 26)
(26, '2024-01-14', 10, 20, 50.00),
(26, '2024-02-11', 28, 40, 90.00),
(26, '2024-03-18', 2, 30, 0),
(26, '2024-04-24', 22, 25, 60.00),
(26, '2024-05-05', 20, 35, 75.00),

-- Game 27: Showdown Poker (GameID = 27)
(27, '2024-01-11', 13, 60, 150.00),
(27, '2024-02-14', 30, 50, 120.00),
(27, '2024-03-30', 5, 35, 0),
(27, '2024-04-13', 4, 80, 200.00),
(27, '2024-05-21', 18, 90, 250.00),

-- Game 28: Mystic Spins Slots (GameID = 28)
(28, '2024-01-15', 7, 5, 12.00),
(28, '2024-02-04', 3, 10, 30.00),
(28, '2024-03-22', 16, 8, 0),
(28, '2024-04-09', 1, 15, 35.00),
(28, '2024-05-06', 24, 20, 50.00),

-- Game 29: All-In Poker (GameID = 29)
(29, '2024-01-17', 14, 200, 500.00),
(29, '2024-02-02', 11, 300, 700.00),
(29, '2024-03-28', 21, 150, 0),
(29, '2024-04-16', 9, 400, 1000.00),
(29, '2024-05-24', 26, 500, 1200.00);
